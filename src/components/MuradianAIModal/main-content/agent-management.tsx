...
export const AgentManagement = () => {
  ...
  const handleCreate = () => {
    const newAgent = addAgent({
      ...
      rules:
        "You are a helpful assistant. Give direct answers and keep them as simple as possible. Avoid unnecessary explanations unless explicitly asked.",
      language: "auto",
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Setup your own system, rules and persona.
            </p>
          </div>
        </div>
        <Button
                      ...
                      <div className="space-y-1">
                        <h3 className="text-lg font-bold flex items-center gap-2">
                          ...
                          {agent.type === "predefined" && (
                            <span className="text-[10px] bg-zinc-100 dark:bg-zinc-800 text-muted-foreground px-2 py-0.5 rounded-full uppercase tracking-widest font-bold">
                              System
                            </span>
                          )}
                        </h3>
