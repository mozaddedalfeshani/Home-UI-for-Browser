  ...
  return (
    <div className="shrink-0 border-t border-border/20 p-1.5">
      ...
      <div className="flex items-end gap-1.5">
        ...
        {/* Bordered textarea */}
        <div className="flex-1 rounded-2xl border border-black/20 bg-background/60 px-1 py-1 backdrop-blur-sm dark:border-white/20">
          <Textarea
            ref={inputRef}
            value={query}
            ...
            rows={1}
            className="max-h-[80px] min-h-10 w-full resize-none rounded-[18px] border-0 bg-transparent px-4 py-2.5 text-sm leading-5 shadow-none focus-visible:ring-0 dark:bg-transparent"
            disabled={isLoading}
          />
        </div>

        {/* Action buttons — outside border */}
        <div className="mb-1 flex items-center gap-1">
          {hasMessages && (
            ...
            >
              <Loader2 className={cn("h-3.5 w-3.5", !isLoading && "hidden")} />
              {!isLoading && (
