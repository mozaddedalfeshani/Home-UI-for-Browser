...
- **সার্চ ফিচার**: নোটের মধ্যে দ্রুত সার্চ করুন
- **ক্যারেক্টার এবং ওয়ার্ড কাউন্ট**: নোটের দৈর্ঘ্য ট্র্যাক করুন
- **কপি ফিচার**: এক ক্লিকে নোট কপি করুন
...
| **Notepad**            | None            | ✅ Multi-note system with search & copy        |
...
| **Background Media**   | None            | ✅ Image/Video background + Dynamic wallpaper  |
| **Reset Function**     | None            | ✅ Complete data reset option                  |
| **Loading States**     | None            | ✅ Skeleton screens                            |
| **Search Modal**       | None            | ✅ Quick search with multiple engines          |
| **Layout Presets**     | None            | ✅ Default, Compact, Focus modes               |
...
- **Frontend**: Next.js 16.2.2, React 19.1.0, TypeScript 5
...
- **Package Manager**: Bun, npm, yarn (multiple lock files present)
...
- **ক্লক স্টাইল**: ক্লাসিক/মডার্ন
- **রাইট সাইড**: নোটপ্যাড প্যানেল চালু/বন্ধ
- **লেআউট মোড**: ডিফল্ট/কম্প্যাক্ট/ফোকাস
- **শর্টকাট পজিশন**: টপ/সেন্টার/বটম
- **রিসাইজ শর্টকাট**: কার্ডের আকার এবং রেডিয়াস
- **ব্যাকগ্রাউন্ড ইমেজ**: ইমেজ/ভিডিও আপলোড/রিমুভ (৫০MB পর্যন্ত)
- **ডাইনামিক ওয়ালপেপার**: প্রতিবার রিফ্রেশে নতুন ওয়ালপেপার
- **ক্লক সেটিং**: ক্লকের রঙ, গ্লো, ফরম্যাট (১২/২৪ঘ) এবং সেকেন্ড
...
│   │   │   ├── ClockZone/     # Digital clock component
│   │   │   ├── TabsZone/      # Shortcuts management
│   │   │   └── GithubLink/    # GitHub link component
│   │   ├── Notepad/           # Multi-note notepad sidebar
│   │   ├── SearchModal/       # Search modal with multiple engines
...
│   │   └── notepadStore.ts    # Multi-note notepad
│   ├── lib/                   # Utilities
│   │   ├── utils.ts           # Utility functions
│   │   └── mediaStorage.ts    # IndexedDB storage for media
│   ├── hooks/                 # Custom hooks
│   │   ├── useKeyboardShortcuts.ts
│   │   ├── useMediaUrl.ts
│   │   └── useDefaultAssets.ts
│   ├── constants/             # Constants
│   │   └── languages.ts       # Translation system (Bengali/English)
...
- **সার্চ শর্টকাট**: "/" কী দিয়ে সার্চ মোডাল খুলুন

### 🔍 সার্চ মোডাল

- **মাল্টি-ইঞ্জিন সাপোর্ট**: Google, DuckDuckGo, Bing, Brave
- **URL ডিটেকশন**: সরাসরি URL লিখলে ওয়েবসাইট খুলবে
- **কীবোর্ড শর্টকাট**: "/" চাপলে সার্চ মোডাল খুলবে
- **নতুন ট্যাবে ওপেন**: সার্চ রেজাল্ট নতুন ট্যাবে ওপেন হবে
...
- **অটো-রিফ্রেশ**: প্রতিবার পেজ রিফ্রেশে নতুন ওয়ালপেপার
- **প্রক্সি API**: ক্যাশিং এড়াতে প্রক্সি ব্যবহার
- **কাস্টম URLs**: নিজস্ব ওয়ালপেপার URL যোগ করুন
- **সেশন ট্র্যাকিং**: একই সেশনে ডুপ্লিকেট ওয়ালপেপার এড়াতে স্মার্ট ট্র্যাকিং

### 📐 লেআউট প্রিসেট

- **ডিফল্ট**: স্ট্যান্ডার্ড লেআউট
- **কম্প্যাক্ট**: জায়গা বাঁচিয়ে ছোট লেআউট
- **ফোকাস**: ডিস্ট্রাকশন-ফ্রি ফোকাস মোড (সাইডবার লুকানো)
...
- **জুস্টান্ড স্টোরেজ**: Zustand persist মিডলওয়্যার

### 🎨 উন্নত কাস্টমাইজেশন

- **ক্লক পজিশনিং**: ৩টি ভিন্ন পজিশনে ক্লক রাখুন
- **ক্লক স্টাইল**: ক্লাসিক এবং মডার্ন স্টাইল
- **শর্টকাট পজিশন**: টপ, সেন্টার, বটম
...
const useSettingsStore = create<SettingsState>()(
  persist((set) => ({
    ...
    language: "bn", // "en" | "bn"
    clockPosition: "top-center", // "top-left" | "top-center" | "top-right"
    clockStyle: "modern", // "classic" | "modern"
    layoutPreset: "default", // "default" | "compact" | "focus"
...
export type Language = "en" | "bn" | "es"; // Add new language type
